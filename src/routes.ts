...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/departments', module: DepartmentsModule },
      {
        ...
        module: InvoiceMethodsPaymentsModule,
      },
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: '/details', module: SchoolChargesDetailsModule },
          {
            ...
            module: SchoolChargesDetailsExtraChargesModule,
          },
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/cash-register', module: CashRegisterModule },
      {
        ...
        module: CashRegisterTransactionsModule,
      },
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/academy-activities-group',
        module: AcademyActivitiesGroupModule,
      },
      ...
      {
        path: '/academy-inscription-concepts',
        module: AcademyInscriptionConceptsModule,
      },
      {
        path: '/academy-inscription-concepts/charges',
        module: AcademyInscriptionChargesModule,
      },
      {
        path: '/charges',
