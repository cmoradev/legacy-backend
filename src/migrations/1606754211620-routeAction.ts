...
export class routeAction1606754211620 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('CREATE TABLE `route_action` (`id` int NOT NULL AUTO_INCREMENT, `routeId` int NOT NULL, `actionId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB');
