...
export class AddBaseEntityAndTransactionEntity1665066129840 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `familia_infofiscal` CHANGE `domicilioFiscalReceptor` `domicilioFiscalReceptor` varchar(5) NOT NULL");
        await queryRunner.query("ALTER TABLE `familia_infofiscal` CHANGE `regimenFiscalReceptor` `regimenFiscalReceptor` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `familia_infofiscal` CHANGE `keyRegimen` `keyRegimen` varchar(255) NOT NULL");
