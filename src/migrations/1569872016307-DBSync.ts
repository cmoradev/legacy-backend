...
export class DBSync1569872016307 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('ALTER TABLE `tie_productos` CHANGE `unidad` `unidad` varchar(20) NOT NULL DEFAULT \'Pieza\'', undefined);
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('ALTER TABLE `tie_venta_detalle` CHANGE `cantidad` `cantidad` decimal(15,3) NOT NULL DEFAULT \'0.000\'', undefined);
    await queryRunner.query('ALTER TABLE `tie_productos` CHANGE `unidad` `unidad` varchar(20) NOT NULL DEFAULT \'Peiza\'', undefined);
