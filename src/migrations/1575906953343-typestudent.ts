...
export class typestudent1575906953343 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('ALTER TABLE `alumnos` CHANGE `id_modalidad` `id_modalidad` enum (\'1\', \'2\', \'3\') NOT NULL DEFAULT \'1\'', undefined);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('ALTER TABLE `alumnos` DROP COLUMN `id_modalidad`', undefined);
    await queryRunner.query('ALTER TABLE `alumnos` ADD `id_modalidad` int NOT NULL DEFAULT \'1\'', undefined);
