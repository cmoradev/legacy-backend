...
export class AddedRelationBetweenStudentsAndSales1578946674794 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('ALTER TABLE `tie_ventas` CHANGE `id_alumno` `id_alumno` int NULL', undefined);
        ...
        await queryRunner.query('ALTER TABLE `tie_ventas` ADD CONSTRAINT `FK_c37bc4db6996dd6211d5140a499` FOREIGN KEY (`id_alumno`) REFERENCES `alumnos`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION', undefined);
    }

    public async down(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query('ALTER TABLE `tie_ventas` DROP FOREIGN KEY `FK_c37bc4db6996dd6211d5140a499`', undefined);
        ...
        await queryRunner.query('ALTER TABLE `tie_ventas` CHANGE `id_alumno` `id_alumno` int NOT NULL', undefined);
