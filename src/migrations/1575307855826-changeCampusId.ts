...
export class changeCampusId1575307855826 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<any> {
    // await queryRunner.query('ALTER TABLE `tie_venta_pagos` DROP FOREIGN KEY `FK_2bb7102d7bce7bc902d333e6754`', undefined);
    // await queryRunner.query('ALTER TABLE `alumnos` DROP FOREIGN KEY `FK_f8f8c33f32a9acb5b7dd28b735d`', undefined);
    // await queryRunner.query('ALTER TABLE `tie_venta_pagos` CHANGE `miniStorePaymentStatusId` `systemPaymentStatusId` int NULL', undefined);
    // await queryRunner.query('ALTER TABLE `alumnos` CHANGE `campusId` `studentCampusId` int NULL', undefined);
    // await queryRunner.query('ALTER TABLE `ac_academias` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP', undefined);
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('ALTER TABLE `ac_academias` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP', undefined);
    await queryRunner.query('ALTER TABLE `alumnos` CHANGE `studentCampusId` `campusId` int NULL', undefined);
    await queryRunner.query('ALTER TABLE `tie_venta_pagos` CHANGE `systemPaymentStatusId` `miniStorePaymentStatusId` int NULL', undefined);
    await queryRunner.query('ALTER TABLE `alumnos` ADD CONSTRAINT `FK_f8f8c33f32a9acb5b7dd28b735d` FOREIGN KEY (`campusId`) REFERENCES `planteles`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION', undefined);
    await queryRunner.query('ALTER TABLE `tie_venta_pagos` ADD CONSTRAINT `FK_2bb7102d7bce7bc902d333e6754` FOREIGN KEY (`miniStorePaymentStatusId`) REFERENCES `estado_pagos`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION', undefined);
  }
