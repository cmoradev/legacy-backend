...
export class AddedInvoiceTypeToInvoices1578516022826 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query('ALTER TABLE `tie_facturas` ADD `invoiceType` enum (\'Income\', \'Expenses\') NOT NULL DEFAULT \'Income\'', undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('ALTER TABLE `tie_facturas` DROP COLUMN `invoiceType`', undefined);
    }
