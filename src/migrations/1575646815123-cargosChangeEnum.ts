...
export class cargosChangeEnum1575646815123 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('ALTER TABLE `ac_descuentos` DROP FOREIGN KEY `FK_0def6dbec21d7387bb79c3eb921`', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` CHANGE `id_formaplicacion`  `id_formaplicacion` enum (\'1\', \'2\') NOT NULL DEFAULT \'1\'', undefined);
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('ALTER TABLE `ac_descuentos` DROP COLUMN `id_formaplicacion`', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` ADD `id_formaplicacion` int NULL', undefined);
