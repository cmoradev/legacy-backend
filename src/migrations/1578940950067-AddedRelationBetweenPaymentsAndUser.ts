...
export class AddedRelationBetweenPaymentsAndUser1578940950067 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('ALTER TABLE `tie_venta_pagos` CHANGE `id_agente` `id_agente` int NULL', undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('ALTER TABLE `tie_venta_pagos` CHANGE `id_agente` `id_agente` int NOT NULL DEFAULT \'0\'', undefined);
