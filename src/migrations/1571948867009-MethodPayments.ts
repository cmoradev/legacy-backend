...
export class MethodPayments1571948867009 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `facturacion_formas_pago` ADD `isActive` tinyint(1) NOT NULL DEFAULT '1'", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `facturacion_formas_pago` DROP COLUMN `isActive`", undefined);
    }
