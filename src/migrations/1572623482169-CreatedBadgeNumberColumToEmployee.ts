...
export class CreatedBadgeNumberColumToEmployee1572623482169 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query('ALTER TABLE `employee` ADD `badgeNumber` varchar(255) NOT NULL', undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('ALTER TABLE `employee` DROP COLUMN `badgeNumber`', undefined);
    }
