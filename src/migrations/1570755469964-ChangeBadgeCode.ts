...
export class ChangeBadgeCode1570755469964 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query('ALTER TABLE `check_in` DROP COLUMN `guestBadgeCode`', undefined);
        await queryRunner.query('ALTER TABLE `check_in` ADD `guestBadgeCode` varchar(255) NULL', undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query('ALTER TABLE `check_in` DROP COLUMN `guestBadgeCode`', undefined);
        await queryRunner.query('ALTER TABLE `check_in` ADD `guestBadgeCode` int NULL', undefined);
    }
