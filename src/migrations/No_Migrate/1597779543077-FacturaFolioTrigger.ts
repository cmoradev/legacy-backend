...
export class FacturaFolioTrigger1597779543077 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`DROP TRIGGER IF EXISTS before_ac_factura_insert`);
        await queryRunner.query(`
        CREATE TRIGGER before_ac_factura_insert
    BEFORE INSERT ON ac_facturas
      FOR EACH ROW  
      BEGIN 
