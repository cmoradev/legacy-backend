...
export class SchoolPaymentsChangeProperty1582301656411 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `periods` DROP COLUMN `isActive`", undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `periods` ADD `isActive` tinyint NOT NULL DEFAULT '1'", undefined);
