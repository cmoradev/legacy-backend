...
export class academygroups1575483602409 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `ac_grupos` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` CHANGE `id_turno` `id_turno` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` CHANGE `id_academia` `id_academia` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` CHANGE `id_ciclo` `id_ciclo` int NULL", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` CHANGE `id_plantel` `id_plantel` int NULL", undefined);
        ...
        await queryRunner.query("ALTER TABLE `ac_grupos` ADD CONSTRAINT `FK_a9cdcc9eee1d15b5a5349c698a4` FOREIGN KEY (`id_turno`) REFERENCES `ac_turnos`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` ADD CONSTRAINT `FK_243f5fd8fceb9f95e19da68b25f` FOREIGN KEY (`id_academia`) REFERENCES `ac_academias`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` ADD CONSTRAINT `FK_2eed19a091f69986036852bdc96` FOREIGN KEY (`id_ciclo`) REFERENCES `ciclos`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` ADD CONSTRAINT `FK_b4c8af6b0721991e0141faf88b7` FOREIGN KEY (`id_plantel`) REFERENCES `planteles`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION", undefined);
    }

    public async down(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `ac_grupos` DROP FOREIGN KEY `FK_b4c8af6b0721991e0141faf88b7`", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` DROP FOREIGN KEY `FK_2eed19a091f69986036852bdc96`", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` DROP FOREIGN KEY `FK_243f5fd8fceb9f95e19da68b25f`", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` DROP FOREIGN KEY `FK_a9cdcc9eee1d15b5a5349c698a4`", undefined);
        ...
        await queryRunner.query("ALTER TABLE `ac_grupos` CHANGE `id_plantel` `id_plantel` int NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` CHANGE `id_ciclo` `id_ciclo` int NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` CHANGE `id_academia` `id_academia` int NOT NULL DEFAULT '0'", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` CHANGE `id_turno` `id_turno` int NOT NULL", undefined);
        await queryRunner.query("ALTER TABLE `ac_grupos` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP", undefined);
