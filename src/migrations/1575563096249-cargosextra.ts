...
export class cargosextra1575563096249 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('ALTER TABLE `ac_descuentos` ADD `typeApplication` enum (\'1\', \'2\') NOT NULL DEFAULT \'1\'', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` ADD `operation` enum (\'1\', \'2\', \'3\', \'4\') NOT NULL DEFAULT \'1\'', undefined);
    ...
    await queryRunner.query('ALTER TABLE `ac_tipo_descuento` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP', undefined);
    await queryRunner.query('ALTER TABLE `ac_formas_aplicacion` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP', undefined);
    ...
    await queryRunner.query('ALTER TABLE `ac_descuentos` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` CHANGE `id_tipo_descuento` `id_tipo_descuento` int NULL', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` CHANGE `id_plantel` `id_plantel` int NULL', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` CHANGE `id_ciclo` `id_ciclo` int NULL', undefined);
    await queryRunner.query('ALTER TABLE `ac_aconceptos` CHANGE `precio` `precio` float NOT NULL DEFAULT \'0\'', undefined);
    await queryRunner.query('ALTER TABLE `ac_turnos` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP', undefined);
    await queryRunner.query('ALTER TABLE `ac_cobros` CHANGE `cambio` `cambio` float NOT NULL DEFAULT \'0\'', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` ADD CONSTRAINT `FK_0def6dbec21d7387bb79c3eb921` FOREIGN KEY (`id_formaplicacion`) REFERENCES `ac_formas_aplicacion`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` ADD CONSTRAINT `FK_abb25671173766c72bbf9b0e1ce` FOREIGN KEY (`id_tipo_descuento`) REFERENCES `ac_tipo_descuento`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` ADD CONSTRAINT `FK_c2a33af69be71557c3604356417` FOREIGN KEY (`id_plantel`) REFERENCES `planteles`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` ADD CONSTRAINT `FK_d3cf601bc066b8a5c58100e8ec4` FOREIGN KEY (`id_ciclo`) REFERENCES `ciclos`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION', undefined);
  }

  public async down(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('ALTER TABLE `ac_aconceptos` DROP FOREIGN KEY `FK_0c0ad3bf9d8d9b8153c6d1a8e5e`', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` DROP FOREIGN KEY `FK_d3cf601bc066b8a5c58100e8ec4`', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` DROP FOREIGN KEY `FK_c2a33af69be71557c3604356417`', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` DROP FOREIGN KEY `FK_abb25671173766c72bbf9b0e1ce`', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` DROP FOREIGN KEY `FK_0def6dbec21d7387bb79c3eb921`', undefined);
    await queryRunner.query('ALTER TABLE `ac_cobros` CHANGE `cambio` `cambio` float(12) NOT NULL DEFAULT \'0\'', undefined);
    await queryRunner.query('ALTER TABLE `ac_turnos` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP', undefined);
    ...
    await queryRunner.query('ALTER TABLE `ac_descuentos` CHANGE `id_ciclo` `id_ciclo` int NOT NULL DEFAULT \'0\'', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` CHANGE `id_plantel` `id_plantel` int NOT NULL', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` CHANGE `id_tipo_descuento` `id_tipo_descuento` int NOT NULL', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` DROP COLUMN `dia_fin`', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` ADD `dia_fin` tinyint(3) NULL', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` DROP COLUMN `dia_inicio`', undefined);
    await queryRunner.query('ALTER TABLE `ac_descuentos` ADD `dia_inicio` tinyint(3) NULL', undefined);
    await queryRunner.query('ALTER TABLE `ac_formas_aplicacion` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP', undefined);
    await queryRunner.query('ALTER TABLE `ac_tipo_descuento` CHANGE `updated_at` `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP', undefined);
    ...
    await queryRunner.query('ALTER TABLE `ac_descuentos` DROP COLUMN `typeApplication`', undefined);
