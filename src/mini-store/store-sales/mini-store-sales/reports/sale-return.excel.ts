...
export class SaleReturnExcel {
    ...
    constructor(
        ...
        this.generate(
            this.addWorksheet(
                `${getNameReport('Devoluciones', this.params).excel}`,
            ),
        );
    }
    ...
    private generate(worksheet: Worksheet): Worksheet {
        ...
        title.value = `Tienda: Reporte de ${getNameReport(this.params.byClient ? 'Devoluciones por cliente' : 'Devoluciones', this.params).title}`
        title.style = {
