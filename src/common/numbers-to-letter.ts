...
export class NumeroALetras {
  ...
  NumeroALetras(num: number, curr?: Partial<Currency>): string {
    const currency: Currency = {
      plural: curr?.plural || 'PESOS CHILENOS',
      singular: curr?.singular || 'PESO CHILENO',
      centPlural: curr?.centPlural || 'CHIQUI PESOS CHILENOS',
      centSingular: curr?.centSingular || 'CHIQUI PESO CHILENO',
    };
    const data = {
      numero: num,
