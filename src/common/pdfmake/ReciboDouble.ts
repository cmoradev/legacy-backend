...
export class ReciboDouble {
    ...
    public addLogo(logo: any) {
        ...
        if (logo) {
            if (typeof logo === 'object') {
                ...
                this.docDefinition.content[5].columns[0] = {
                    width: logo.width,
                    image: logo.image,
                    height: logo.height,
                    alignment: 'left'
    ...
    public addFolio2(folio: string) {
        ...
        this.docDefinition.content[5].columns[3][1].table.body.push(data);
    }
    ...
    public addDate2(date: string) {
        ...
        this.docDefinition.content[5].columns[3][2].table.body.push(data)
    }
    ...
    public addEmisor(emisor: { name: string, rfc: string, regimen: string, expedido: string }) {
        ...
        this.docDefinition.content[5].columns[2].text[0].text = emisor.name.toUpperCase() + '\n'
        this.docDefinition.content[5].columns[2].text[1].text[1].text = emisor.rfc + '\n'
        this.docDefinition.content[5].columns[2].text[2].text[1].text = emisor.regimen + '\n'
        this.docDefinition.content[5].columns[2].text[3].text[1].text = emisor.expedido + '\n';
    }
    ...
    public addInformacion(info: { vendedor: string }) {
        ...
        this.docDefinition.content[6].columns[2].text[2] = { text: info.vendedor + '\n' }
    }
    ...
    public addCatidad(comprobante: { SubTotal: string, Recargo: string, Descuento: string, Impuesto: string, Total: string }) {
        ...
        this.docDefinition.content[8].table.body[0][1].text[1] = { text: '$' + comprobante.SubTotal + '\n' }
        this.docDefinition.content[8].table.body[0][1].text[3] = { text: '$' + comprobante.Recargo + '\n' }
        this.docDefinition.content[8].table.body[0][1].text[5] = { text: '$' + comprobante.Descuento + '\n' }
        this.docDefinition.content[8].table.body[0][1].text[7] = { text: '$' + comprobante.Impuesto + '\n' }
        this.docDefinition.content[8].table.body[0][1].text[9] = { text: '$' + comprobante.Total + '\n' }
    }
    ...
    public addNumberToLetter(total: number) {
        ...
        this.docDefinition.content[8].table.body[0][0].stack[1].text = nue.NumeroALetras(total, {
            plural: 'PESOS',
            singular: 'PESO',
            centPlural: 'CENTAVOS',
            centSingular: 'CENTAVO'
    ...
    public addObervations(comment: string) {
        ...
        this.docDefinition.content[8].table.body[0][0].stack[3].text = comment
    }
    ...
    public addFormaPago(detalles: any[]) {
        for (const con of detalles) {
            ...
            this.docDefinition.content[9].table.body.push([
                {
                    text: con.forma
                },
                {
